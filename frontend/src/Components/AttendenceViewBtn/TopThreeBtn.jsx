...
const TopThreeBtn = ({expend, ToggleModal}) => {
  ...
  return (
    <div>
      <div className="p-4 rounded-lg absolute left-160 top-20 flex flex-row gap-3 cursor-pointer">
              {Data.map((btn) => 
