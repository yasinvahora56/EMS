...
const AttendenceManage = ({expend, ToggleModal}) => {
  ...
  return (
    <> 
      {expend && (
        <div className="absolute top-60 justify-between min-w-48 left-60 right-10 p-6">
        {/* Header Section */}
        <header className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-bold text-gray-800 relative left-10">Attendance & Leave Management</h1>
